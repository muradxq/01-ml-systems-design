...
|--------|-----------------|----------------|-------------------|
| [Recommendation Systems](./01-recommendation-systems.md) | Ranking, Collaborative Filtering | Cold start, scalability | Netflix, Amazon, Spotify |
| [Search Systems](./02-search-systems.md) | Information Retrieval, Ranking | Latency, relevance | Google, Elasticsearch, E-commerce |
| [Fraud Detection](./03-fraud-detection.md) | Binary Classification | Real-time, imbalanced data | Banks, Payment processors |
| [Computer Vision](./04-computer-vision-systems.md) | Image Classification, Detection | GPU scaling, latency | Autonomous vehicles, Medical imaging |
| [NLP Systems](./05-nlp-systems.md) | Text Classification, Generation | Model size, context | Chatbots, Translation, Search |
| [Time Series Forecasting](./06-time-series-forecasting.md) | Regression, Sequence Modeling | Seasonality, drift | Finance, Supply chain, Weather |
| [Ad Click Prediction](./07-ad-click-prediction.md) | Binary Classification, Calibration | Auction fairness, delayed feedback | Meta, Google Ads |
| [Feed Ranking](./08-feed-ranking.md) | Multi-objective Ranking | Diversity, integrity | Meta, Instagram |
| [Content Moderation](./09-content-moderation.md) | Multi-label Classification | Multi-modal, scale, precision/recall | Meta, Twitter, YouTube |
| [People You May Know (PYMK)](./10-people-you-may-know.md) | Graph-based Ranking | Scale, cold start, privacy | Meta, LinkedIn |
| [Autocomplete & Typeahead](./11-autocomplete-typeahead.md) | Ranking, Trie, LM | Latency, multi-language, safety | Google, Search |
| [Notification Ranking](./12-notification-ranking.md) | Multi-objective Ranking | Fatigue, send-time, channels | Meta, Google |
| [Conversational AI / Chatbot](./13-chatbot-llm-system.md) | Intent, RAG, Dialog | Safety, containment, latency | Meta, Google |
| [Video Recommendation](./14-video-recommendation.md) | Multi-stage Ranking | Watch time, diversity, scale | YouTube, Google |
| [Entity Resolution](./15-entity-resolution.md) | Record Linkage, Clustering | Precision, scale, blocking | Data platforms |
...
Continue to:
1. [Recommendation Systems](./01-recommendation-systems.md)
2. [Search Systems](./02-search-systems.md)
3. [Fraud Detection](./03-fraud-detection.md)
4. [Computer Vision Systems](./04-computer-vision-systems.md)
5. [NLP Systems](./05-nlp-systems.md)
6. [Time Series Forecasting](./06-time-series-forecasting.md)
7. [Ad Click Prediction](./07-ad-click-prediction.md)
8. [Feed Ranking](./08-feed-ranking.md)
9. [Content Moderation](./09-content-moderation.md)
10. [People You May Know (PYMK)](./10-people-you-may-know.md)
11. [Autocomplete & Typeahead](./11-autocomplete-typeahead.md)
12. [Notification Ranking](./12-notification-ranking.md)
13. [Conversational AI / Chatbot](./13-chatbot-llm-system.md)
14. [Video Recommendation](./14-video-recommendation.md)
15. [Entity Resolution](./15-entity-resolution.md)
