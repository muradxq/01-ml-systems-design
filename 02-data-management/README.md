...
2. [Data Storage](./data-storage.md)
   - Storage architectures
   - Data lakes vs warehouses
   - Storage optimization

3. [Data Versioning](./data-versioning.md)
   - Why version data
...
- Learn about [Data Collection](./data-collection.md)
- Understand [Data Storage](./data-storage.md)
- Explore [Data Versioning](./data-versioning.md)
- Study [Data Quality](./data-quality.md)

Then proceed to [Feature Engineering](../03-feature-engineering/README.md) to learn how to transform data into features.
