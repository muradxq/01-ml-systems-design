...
- [Horizontal Scaling](./01-horizontal-scaling.md) - Scale with caching
- [Optimization Techniques](./04-optimization-techniques.md) - Other optimizations
- [Batch vs Real-time](./03-batch-vs-realtime.md) - Pre-compute for batch
