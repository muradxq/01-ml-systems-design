...
- [Caching Strategies](./02-caching-strategies.md) - Reduce load with caching
- [Optimization Techniques](./04-optimization-techniques.md) - Make each instance faster
- [Batch vs Real-time](./03-batch-vs-realtime.md) - Processing patterns
