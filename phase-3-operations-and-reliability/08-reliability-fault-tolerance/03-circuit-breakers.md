...
- [High Availability](./01-high-availability.md) - System-wide availability
- [Graceful Degradation](./02-graceful-degradation.md) - What to do when circuit opens
- [Disaster Recovery](./04-disaster-recovery.md) - Recovering from failures
