...
- [High Availability](./high-availability.md) - Prevent failures
- [Circuit Breakers](./circuit-breakers.md) - Fast failure detection
- [Caching Strategies](../07-scalability-performance/caching-strategies.md) - Cache for fallbacks
