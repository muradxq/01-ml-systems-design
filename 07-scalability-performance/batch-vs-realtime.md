...
- [Horizontal Scaling](./horizontal-scaling.md) - Scale real-time systems
- [Caching Strategies](./caching-strategies.md) - Serve batch results
- [Feature Stores](../03-feature-engineering/feature-stores.md) - Online/offline features
