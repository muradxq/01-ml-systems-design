...
- [Horizontal Scaling](./horizontal-scaling.md) - Scale after optimization
- [Caching Strategies](./caching-strategies.md) - Cache optimized predictions
- [Model Serving](../05-model-serving/README.md) - Serve optimized models
